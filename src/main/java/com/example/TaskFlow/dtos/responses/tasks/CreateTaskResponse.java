...
public record CreateTaskResponse(Long id, String title, String description, TaskStatus status, Priority priority, LocalDateTime deadline, Long userId, Long projectId, LocalDateTime createdAt, LocalDateTime updatedAt) {
